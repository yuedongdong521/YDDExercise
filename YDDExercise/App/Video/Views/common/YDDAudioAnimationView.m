...
@implementation YDDAudioAnimationView
...
{
    if (!_audioImageView) {
        _audioImageView = [[UIImageView alloc] initWithFrame:CGRectMake(2, 2, 32, 32)];
        ...
        _audioImageView.layer.cornerRadius = 16;
    }
...
- (UIBezierPath *)path {
    if (!_path) {
        ...
        // 设置第一个控制点
        CGPoint controlPoint1 = CGPointMake(-40, self.frame.size.height);
        // 添加三次贝塞尔曲线
