...
@interface YDDDetailsViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation YDDDetailsViewController
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    return [self.list[indexPath.row] ydd_textSize:CGSizeMake(ScreenWidth - 30, 1000) font:[UIFont systemFontOfSize:17]].height + 20;
}
