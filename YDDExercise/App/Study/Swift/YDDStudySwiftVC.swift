...
class YDDStudySwiftVC: YDDBaseViewController {
    ...
    fileprivate lazy var dataArr: Array<String> = {
       return ["YDDRxSwiftVC", "YDDRxObservable", "YDDRxBinderVC",
               "YDDRxSubjectsVC", "YDDRxTransformingVC", "YDDRxCollectionViewController", "YDDRunLoopUserVC", "YDDAudioViewController", "YDDAlgorithmViewController", "OCSwiftRuntimeVC", "YDDOffScreenViewController", "YDDTableViewViewController"]
    }()
