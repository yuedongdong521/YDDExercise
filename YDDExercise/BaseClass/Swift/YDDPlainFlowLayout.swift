...
enum YDDCollectionHeaderStyle {
    case plain
    case grouped
}

class YDDPlainFlowLayout: UICollectionViewFlowLayout {
    var c_navHeight: CGFloat = 64
    var c_headStyle: YDDCollectionHeaderStyle = .grouped
    ...
    weak var c_flowLayoutDelegate: YDDFlowLayoutProtocol?
    ...
    override func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
        ...
        if c_headStyle == YDDCollectionHeaderStyle.plain {
