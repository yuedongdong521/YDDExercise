...
static CGFloat const PPStickerScrollViewHeight = 180.0+48;
...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        self.backgroundColor = [UIColor pp_colorWithRGBString:@"#EEEEEE"];
...
//    return PPStickerTopInset + PPStickerScrollViewHeight + PPKeyboardPageControlTopMargin + PPKeyboardPageControlHeight + PPKeyboardPageControlBottomMargin + PPKeyboardCoverButtonHeight + bottomInset;
    ...
    return PPStickerTopInset + PPStickerScrollViewHeight + PPKeyboardPageControlTopMargin + PPKeyboardPageControlHeight + PPKeyboardPageControlBottomMargin;
}
...
- (UIPageControl *)pageControl
{
    if (!_pageControl) {
        ...
        _pageControl.currentPageIndicatorTintColor = [UIColor pp_colorWithRGBString:@"#7D7D7D"];
        _pageControl.pageIndicatorTintColor = [UIColor pp_colorWithRGBString:@"#D2D2D2"];
