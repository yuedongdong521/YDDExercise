...
NSUInteger const PPStickerPageViewMaxEmojiCount = 34; //表情面板每页数量20个
static NSUInteger const PPStickerPageViewLineCount = 5; //行数
static NSUInteger const PPStickerPageViewButtonPerLine = 7; //每行7个
